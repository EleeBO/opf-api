...
[![CI](https://github.com/shiftbloom-studio/opf-api/actions/workflows/ci.yml/badge.svg)](https://github.com/shiftbloom-studio/opf-api/actions/workflows/ci.yml)
[![Deploy AWS](https://github.com/shiftbloom-studio/opf-api/actions/workflows/deploy-aws.yml/badge.svg)](https://github.com/shiftbloom-studio/opf-api/actions/workflows/deploy-aws.yml)
...
```bash
git clone https://github.com/shiftbloom-studio/opf-api.git
cd opf-api
cp .env.example .env
```
